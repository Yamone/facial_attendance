...
def main(input_dir, output_dir, crop_dim):
    ...
    for extension in extensions:
        img_paths = glob.glob(os.path.join(input_dir, '**/*.'+extension))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str, action='store', default='data', dest='input_dir')
    parser.add_argument('--output_dir', type=str, action='store', default='output', dest='output_dir')
